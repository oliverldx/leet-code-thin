...
![](media/15b3c0141d5910ad24cdaef8f6206e23550821c3.png)
...
![图一](media/7b270cb0d91b9e1697b77b458d17bc6188475407.png)

步骤二：在遍历地图，将'O'全部改成'X'（地图中间的'O'改成了'X'），将'A'改回'O'（保留的地图周边的'O'），如图所示：

![图二](media/7311935ace930d2c56287a965995fbdf33ad6c53.png)
