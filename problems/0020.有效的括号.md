...
1.  第一种情况，字符串里左方向的括号多余了 ，所以不匹配。
    ![括号匹配1](media/eb2956c6bf1496cd99e6f370297ddc802fc60a57.png)

2.  第二种情况，括号没有多余，但是 括号的类型没有匹配上。
    ![括号匹配2](media/2071c5a4f523a1536609a3baa8055dec36597735.png)

3.  第三种情况，字符串里右方向的括号多余了，所以不匹配。
    ![括号匹配3](media/aacc5fde535116c45ca0792cea41d51c2d879c89.png)

我们的代码只要覆盖了这三种不匹配的情况，就不会出问题，可以看出 动手之前分析好题目的重要性。

动画如下：

![20.有效括号](media/https:/code-thinking.cdn.bcebos.com/gifs/20.有效括号.gif)
